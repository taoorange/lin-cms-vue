...
const data = [
  ...
  },
  {
    ...
    cityList: [
      ...
      { name: '北区', code: '810010' },
      { name: '大埔区', code: '810011' },
      { name: '沙田区', code: '810012' },
      { name: '西贡区', code: '810013' },
      { name: '荃湾区', code: '810014' },
      { name: '屯门区', code: '810015' },
      { name: '元朗区', code: '810016' },
    ...
    cityList: [
      {
        ...
        code: '710100',
        areaList: [
          { code: '710101', name: '内湖区' },
          { code: '710102', name: '南港区' },
          { code: '710103', name: '中正区' },
          { code: '710104', name: '万华区' },
          { code: '710105', name: '大同区' },
          { code: '710106', name: '中山区' },
          { code: '710107', name: '松山区' },
          { code: '710108', name: '大安区' },
          { code: '710109', name: '信义区' },
          { code: '7101010', name: '文山区' },
      ...
      },
      {
        ...
        areaList: [
          ...
          { code: '710202', name: '汐止区' },
          { code: '710203', name: '新店区' },
          { code: '710204', name: '永和区' },
          { code: '710205', name: '中和区' },
          { code: '710206', name: '土城区' },
          { code: '710207', name: '树林区' },
          { code: '710208', name: '三重区' },
          { code: '710209', name: '新庄区' },
          { code: '710210', name: '芦洲区' },
          { code: '710211', name: '瑞芳区' },
          { code: '710212', name: '三峡区' },
          { code: '710213', name: '莺歌区' },
          { code: '710214', name: '淡水区' },
          { code: '710215', name: '万里区' },
          { code: '710216', name: '金山区' },
          { code: '710217', name: '深坑区' },
          { code: '710218', name: '石碇区' },
          { code: '710219', name: '平溪区' },
          { code: '710220', name: '双溪区' },
          { code: '710221', name: '贡寮区' },
          { code: '710222', name: '坪林区' },
          { code: '710223', name: '乌来区' },
          { code: '710224', name: '泰山区' },
          { code: '710225', name: '林口区' },
          { code: '710226', name: '五股区' },
          { code: '710227', name: '八里区' },
          { code: '710228', name: '三芝区' },
          { code: '710229', name: '石门区' },
        ],
      },
      {
        name: '桃园市',
        ...
        areaList: [
          ...
          { code: '710307', name: '大溪区' },
          { code: '710308', name: '龙潭区' },
          { code: '710309', name: '龟山区' },
          { code: '710310', name: '大园区' },
          { code: '710311', name: '观音区' },
          { code: '710312', name: '新屋区' },
      ...
      },
      {
        ...
        areaList: [
          ...
          { code: '710415', name: '潭子区' },
          { code: '710416', name: '大雅区' },
          { code: '710417', name: '神冈区' },
          { code: '710418', name: '石冈区' },
          { code: '710419', name: '东势区' },
          { code: '710420', name: '新社区' },
          { code: '710421', name: '和平区' },
      ...
      },
      {
        ...
        code: '710600',
        areaList: [
          { code: '701601', name: '楠梓区' },
          { code: '701602', name: '左营区' },
          { code: '701603', name: '鼓山区' },
          { code: '701604', name: '三民区' },
          { code: '701605', name: '盐埕区' },
          { code: '701606', name: '前金区' },
          { code: '701607', name: '新兴区' },
          { code: '701608', name: '苓雅区' },
          { code: '701609', name: '前镇区' },
          { code: '701610', name: '旗津区' },
          { code: '701611', name: '小港区' },
          { code: '701612', name: '凤山区' },
          { code: '701613', name: '大寮区' },
          { code: '701614', name: '鸟松区' },
          { code: '701615', name: '林园区' },
          { code: '701616', name: '仁武区' },
          { code: '701617', name: '大树区' },
          { code: '701618', name: '大社区' },
          { code: '701619', name: '冈山区' },
          { code: '701620', name: '路竹区' },
          { code: '701621', name: '桥头区' },
          { code: '701622', name: '梓官区' },
          { code: '701623', name: '弥陀区' },
          { code: '701624', name: '永安区' },
          { code: '701625', name: '燕巢区' },
          { code: '701626', name: '阿莲区' },
          { code: '701627', name: '茄萣区' },
          { code: '701628', name: '湖内区' },
          { code: '701629', name: '田寮区' },
          { code: '701630', name: '旗山区' },
          { code: '701631', name: '美浓区' },
          { code: '701632', name: '内门区' },
          { code: '701633', name: '杉林区' },
          { code: '701634', name: '甲仙区' },
          { code: '701635', name: '六龟区' },
          { code: '701636', name: '茂林区' },
          { code: '701637', name: '桃源区' },
          { code: '701638', name: '那玛夏区' },
        ],
      },
      {
        name: '基隆市',
        code: '710700',
        areaList: [
          { code: '710701', name: '中正区' },
          { code: '710702', name: '七堵区' },
          { code: '710703', name: '暖暖区' },
          { code: '710704', name: '仁爱区' },
          { code: '710705', name: '中山区' },
          { code: '710706', name: '安乐区' },
          { code: '710707', name: '信义区' },
        ],
      },
      {
        name: '新竹市',
      ...
      { code: '711000', name: '宜兰县' },
      { code: '712000', name: '新竹县' },
      { code: '713000', name: '苗栗县' },
      { code: '714000', name: '彰化县' },
      { code: '715000', name: '南投县' },
      { code: '716000', name: '嘉义县' },
      { code: '717000', name: '云林县' },
      { code: '718000', name: '屏东县' },
      { code: '719000', name: '台东县' },
      { code: '711100', name: '花莲县' },
      { code: '711200', name: '澎湖县' },
      { code: '711300', name: '金门县' },
      { code: '711400', name: '连江县' },
    ],
  },
]
export default data
